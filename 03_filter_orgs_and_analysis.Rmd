...
Black_majority_neighborhoods <-neighborhood_AAperc %>% filter(Percent_AA>=50) %>% pull(Name)

length(Black_majority_neighborhoods) # number of black majority neighborhoods

Not_Black_majority_neighborhoods <-neighborhood_AAperc %>% filter(Percent_AA<50) %>% pull(Name)

length(Not_Black_majority_neighborhoods)

pop_in_black_neighborhoods <-filter(df_simplified, Name %in% Black_majority_neighborhoods) %>% pull(Population) %>% sum()
#population living in Black majority neighborhoods
pop_in_black_neighborhoods

pop_not_in_black_neighborhoods <- filter(df_simplified, !(Name %in% Black_majority_neighborhoods)) %>% pull(Population) %>% sum(na.rm = TRUE)
