...
```{r}
irs_new_old<- read_csv("data/eo_md.csv") #older
```
...
# specify character for last column
 epost_old <- read_delim("data/data-download-epostcard.txt", 
     delim = "|", escape_double = FALSE, col_names = FALSE, 
     trim_ws = TRUE, col_types = c("X26" = "c"))

#trying a different way to read in the data with different column lengths
epost <- read.table("data/data-download-epostcard.txt",  col.names = paste0("V", seq_len(28)), fill = TRUE, header=FALSE, sep="|")
