...
library(naniar)
install.packages(c('leafem', 'leafgl', 'leaflegend', 'leaflet', 'leafsync', 'maptiles', 'sf', 'stars', 's2', 'tmaptools', 'units', 'tmap', 'sf'), repos = "https://cloud.r-project.org", dependencies = TRUE)
library(sf)
#library(s2)
#library(units)
```
