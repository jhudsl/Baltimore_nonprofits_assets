...
# Limiting to Just Baltimore based on coordinates
...
in_balt[43,]$intersection # row for intersection
in_balt[43,]$EIN # org id
in_balt[43,]$ORG_ADDR_FULL # this looks like downtown when you look it up
...
in_balt[58,]$intersection # row for intersection
in_balt[58,]$EIN # org id
in_balt[58,]$ORG_ADDR_FULL # this looks like downtown when you look it up
...
in_balt[65,]$intersection # row for intersection
in_balt[65,]$EIN # org id
in_balt[65,]$ORG_ADDR_FULL # this looks like downtown when you look it up
...
# Combining it all together so that shape information and org data are together:
