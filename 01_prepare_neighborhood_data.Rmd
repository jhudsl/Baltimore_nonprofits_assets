...
library(naniar)
install.packages(c('RNetCDF', 'ncmeta', 'sf', 'stars', 'areal', 'leafem', 'leafgl', 'leaflegend', 'leaflet', 'leafsync', 'maptiles', 'sf', 'stars', 's2', 'tmaptools', 'units', 'tmap', 'sf', 'raster', 'lwgeom', 'leafpop','satellite', 'mapview'), repos = "https://cloud.r-project.org", dependencies = TRUE)
library(sf)
#library(s2)
#library(units)
```
