...
epost_table <- read.table("New_version_data/data-download-epostcard.txt",  col.names = paste0("V",seq_len(28)), fill = TRUE, header=FALSE, sep="|")
...
MaybeMD_probs <-probem_rows %>% filter(if_any(.cols = everything(), ~ grepl("MD", .)))
```
